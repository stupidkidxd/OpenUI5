sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("zjblessons.MasterDetail.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zjblessons.MasterDetail.controller.ListSelector
			 */
			 ...
			 * @return {zjblessons.MasterDetail.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
