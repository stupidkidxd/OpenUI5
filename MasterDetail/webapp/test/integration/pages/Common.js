sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zjblessons/MasterDetail/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("zjblessons.MasterDetail.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zjblessons/MasterDetail/localService/mockserver"], function (mockserver) {
